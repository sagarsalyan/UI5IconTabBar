jQuery.sap.declare("com.peol.firstProject.util.messages");
jQuery.sap.require("sap.ca.ui.message.message");

com.peol.firstProject.util.messages = {};
 ...
 * @public
 */
com.peol.firstProject.util.messages.showErrorMessage = function(oParameter) {
	var oErrorDetails = com.peol.firstProject.util.messages._parseError(oParameter);
...
com.peol.firstProject.util.messages.getErrorContent = function(oParameter) {
	return com.peol.firstProject.util.messages._parseError(oParameter).sMessage;
};

com.peol.firstProject.util.messages._parseError = function(oParameter) {
	var sMessage = "",
		sDetails = "",
		oEvent = null,
		oResponse = null,
